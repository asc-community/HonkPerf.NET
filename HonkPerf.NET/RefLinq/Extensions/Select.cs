...
static partial class LazyLinqExtensions
{
    ...
    public static RefLinqEnumerable<U, Select<T, U, TDelegate, TPrevious>> Select<T, U, TCapture, TDelegate, TPrevious>(this RefLinqEnumerable<T, TPrevious> prev, TDelegate map)
        where TPrevious : IRefEnumerable<T>
